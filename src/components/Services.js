...
const Services = () => {
  const contentData = [
    ...
    },
    {
      ...
      description: 'Create your own website with A3-Schools Spaces-no setup required',
    },
    {
    ...
    <>
      <Container fluid className="services pt-4 ps-5 pb-4">
        ...
        <Row className="mt-4 ms-4">
          <Col xs={7}>
            A3Schools offers a wide range of services and products for beginners and professionals,
