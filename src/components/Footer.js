  ...
  return (
    <div id="footerwrapper">
      ...
      <div class="footersome">
        <a target="_blank" href="/" title="A3schools on Facebook">
        ...
        <a
          target="_blank"
          href="/"
          title="Join the A3schools community on Discord"
        >
          <i class="fab fa-discord st "></i>
        </a>
        <a target="_blank" href="/" title="A3Schools on LinkedIn">
          <i class="fab fa-linkedin-in st"></i>
        </a>
        <a target="_blank" href="/" title="A3Schools on Instagram">
          <i class="fa fa-instagram st"></i>
        </a>
        <a target="_blank" href="/" title="Forum" class="textlink">
          FORUM
        </a>
        <a target="_blank" href="/" title="About A3Schools" class="textlink">
          ABOUT
        </a>
      </div>
      <div class="footertext">
        A3Schools is optimized for learning and training. Examples might be
        ...
        <br class="footer-hide-special" />
        of all content. While using A3Schools, you agree to have read and
        accepted our{" "}
        <a href="/" class="alinks">
          terms of use
        </a>
        ...
        <a href="/" class="alinks">
          A3Schools is Powered by A3.CSS
        </a>
        .<br />
        <br />
      </div>
